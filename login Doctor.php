...
<head>
    ...
    <title>Login - Suwani Pharmacy</title>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background: url(&quot;assets/img/login2jpg.jpg&quot;) center / contain no-repeat;padding: 31px;padding-top: 51px;padding-right: 30px;height: 532px;"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center"><a class="small" href="Doctor%20forgot-password.php">Forgot Password?</a></div>
                                    <div class="text-center"><a class="small" href="Update%20Doctor%20Details.php">Create an Account!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
