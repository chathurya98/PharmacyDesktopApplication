    ...
    <div id="wrapper">
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="Invoice_management.php"><i class="fas fa-file-invoice"></i><span>Invoice Management</span></a><a class="nav-link" href="Stock_management.php"><i class="fas fa-box"></i><span>Stock Management</span></a>
                        <a
                            class="nav-link" href="supplier%20Management.php"><i class="fas fa-truck-moving"></i><span>Supplier Management</span></a><a class="nav-link" href="staff_mangement.php"><i class="fas fa-user-tie"></i><span>Staff Management</span></a><a class="nav-link active" href="Doctor_management.php"><i class="fas fa-syringe"></i><span>Doctor Management</span></a>
                            <a
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-1" style="margin-top: 0px;">
                
                <button class="btn btn-primary py-0" type="button" style="background: #116e80;"><i class="fas fa-search"></i></button><input class="bg-light border-0 small" type="text" placeholder="Search By Doctor Name......" style="margin-top: -7px;padding-top: 12px;padding-bottom: 18px;">
                    
                <a class="btn btn-primary text-center" role="button" style="padding-left: 22px;margin-left: 394px;background: rgb(227,45,89);" href="Register%20Doctor.php">+ Add Doctor</a>
                        
                <a class="btn btn-sucess text-center" role="button"  href="doctordetails_showmore.php">View Doctors</a>
                ...
                <?php 
				   ...
				   $sql = "SELECT * FROM doctor LIMIT 24";
				   ...
				   ?>
                    ...
                    <div class="col-4 py-3 mx-auto col-xl-4 col-lg-6 col-md-6 col-sm-12" style="min-width:300px;min-height:300px;">
                        <div class="card mb-4 box-shadow"><img class="card-img-top w-100 d-block" src="uploads/<?php echo $row["doc_pic"]; ?>" style="width: 250px;height: 350px;">
                            <div class="card-body">
							<h5  style="font-family: 'Abril Fatface', cursive;">Dr. <?php echo $row["f_name"]; ?></h4>
                                <h4 class="text-center text-muted card-subtitle" style="font-family: 'Abril Fatface', cursive;"><?php echo $row["specialization"]; ?></h4>
                                <br>
                                <h6 class="text-center text-muted card-subtitle mb-2">Residence : <?php echo $row["address"]; ?></h6>
                                <h6 class="text-center text-muted card-subtitle mb-2">Dispensary : <?php echo $row["dispensary_location"]; ?></h6>
                                <h6 class="text-center text-muted card-subtitle mb-2">Hospital : <?php echo $row["work_hospital"]; ?></h6>
                                <div class="btn-group" role="group"><a class="btn btn-primary" role="button" href="Register%20Doctor.php?id=<?php echo $row["doc_id"];?>" style="margin-right:5px;">Update</a>
                                <a class="btn btn-primary" role="button" href="./logic/doc_del.php?doc_id=<?php echo $row['doc_id']; ?>" >Delete</a></div>
                            </div>
                        </div>
                    </div>
